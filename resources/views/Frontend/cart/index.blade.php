                        ...
                        <table class="table axil-product-table axil-cart-table mb--40">
                            ...
                            @forelse($products as $product)
                                <tr>
                                    ...
                                    <td class="product-thumbnail"><a href="{{ route("products.single", ['slug' => $product->product->slug]) }}"><img src="{{ url('/') }}/storage/{{ $product->product->image }}" alt="{{ $product->product->name }}"></a></td>
